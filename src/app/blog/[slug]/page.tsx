...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: post.ogImage || post.imageUrl, // Use specific OG image if available
          width: post.ogImage ? 1200 : 600, // Typical OG image width
          height: post.ogImage ? 630 : 400, // Typical OG image height
    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        <article className="bg-card shadow-xl rounded-lg overflow-hidden p-6 md:p-10">
          ...
          {/* For HTML content from a trusted source */}
          <div
            className="prose prose-lg dark:prose-invert max-w-none text-foreground/90 
                       ...
                       prose-li:mb-2" // Changed from prose-li:my-1
