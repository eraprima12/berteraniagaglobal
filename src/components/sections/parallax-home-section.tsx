    ...
    >
      ...
      <div className="relative z-20 p-4 max-w-4xl">
        <h1
          ...
          className={`${alexBrush.className} text-7xl sm:text-8xl md:text-9xl mb-10 leading-tight`}
        ...
        <Button
          size="lg" 
          variant="default" 
          className="bg-accent hover:bg-accent/90 text-accent-foreground px-10 py-4 text-xl rounded-lg shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl" 
